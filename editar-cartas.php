...
$sql = "SELECT Nombre, Tipo, PS, Ataque, Precio, Descripcion, ID_Usuario, en_venta  FROM carta WHERE ID_Carta = {$_SESSION["editar-cartas"]}";
...
<body>
    ...
    <form action="guardar_cambios_en_cartas.php" method="POST">
        <!-- Nombre -->
        ...
        <div class="input-group">
            ...
            <input type="text" id="ps" name="ps" value="<?php echo $ps; ?>" required>
        </div>

        <!-- Ataque -->
        <div class="input-group">
            <label for="ataque">Ataque</label>
            <input type="text" id="ataque" name="ataque" value="<?php echo $ataque; ?>" required>
        </div>
        ...
        <div class="input-group">
            ...
            <input type="number" id="usuario" name="usuario" value="<?php echo $id_usuario; ?>" required>
        </div>

        <!-- En_venta -->
        <div class="input-group">
            <label for="enventa">En Venta</label>
            <input type="number" id="enventa" name="enventa" value="<?php echo $venta; ?>" required>
        </div>
